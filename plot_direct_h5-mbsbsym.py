...
errors = np.flip(np.rot90(np.vstack((e1, [np.nan,np.nan], e2, [3.34, 3.34])), k=-1), axis=1)
...
plt.savefig("figures/for_mbsb_symposium.png", dpi=300, transparent=True)
